  ...
  return {
    ...
    use: {
      ...
      trace: process.env.PW_TRACE_RICH !== "false"
        ? { mode: "retain-on-failure" as const, snapshots: { dom: true, aria: true, screen: true }, screenshots: true, sources: true }
        : "retain-on-failure",
    ...
    projects: [
      {
        ...
        use: {
          ...
          trace: { mode: "retain-on-failure" as const, snapshots: { dom: true, aria: true, screen: true }, screenshots: true, sources: true },
          screenshot: "only-on-failure",
          video: "off",
