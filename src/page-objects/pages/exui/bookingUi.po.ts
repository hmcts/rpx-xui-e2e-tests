...
import { navigateWithTransientGatewayRetry } from "../../../tests/integration/utils/transientGatewayPage.utils.js";
...
export const getUtcDayRangeForLocalDate = (beginDate: Date, endDate: Date): BookingDayRange => ({
  beginDate: new Date(
    Date.UTC(beginDate.getFullYear(), beginDate.getMonth(), beginDate.getDate(), 0, 0, 0, 0)
  ).toISOString(),
  endDate: new Date(
...
export class BookingUiPage extends Base {
  ...
  public async goto(): Promise<void> {
    await navigateWithTransientGatewayRetry(this.page, "/booking", {
      contextLabel: "booking UI",
  ...
  public async chooseBookingOption(optionText: string): Promise<void> {
