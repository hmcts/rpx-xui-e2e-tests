/* eslint-disable playwright/no-wait-for-timeout -- EXUI create-case navigation exposes spinner and route state only, so this flow uses bounded polling with explicit deadlines. */
