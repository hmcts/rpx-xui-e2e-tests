...
export class TaskListPage extends Base {
  readonly taskListFilterToggle = this.page.locator(
    ".govuk-button.hmcts-button--secondary",
  );
  readonly selectAllServicesFilter = this.page.locator(
    "input#checkbox_servicesservices_all",
  );
  ...
  readonly taskActionMarkAsDone =
    this.taskListTable.locator("#action_complete");
  ...
  readonly taskActionClaimAndGo = this.taskListTable.locator(
    "#action_claim-and-go",
  );
