...
export class ExuiHeaderComponent {
  ...
  readonly headerMenuItems = this.page.locator(
    ".hmcts-primary-navigation li.hmcts-primary-navigation__item",
  );
  readonly headerAppLink = this.header
    ...
    .or(
      this.page
        .getByRole("banner")
        .getByRole("link", { name: /Manage Cases|Rheoli Achosion/ }),
    );
  ...
  readonly languageToggle = this.header
    ...
    .or(
      this.page
        .getByRole("banner")
        .getByRole("button", { name: /Cymraeg|English/ }),
    );
  ...
  readonly signOutLink = this.header
    ...
    .or(
      this.page
        .getByRole("banner")
        .getByRole("link", { name: /Sign out|Allgofnodi/ }),
    );

  readonly notificationBanner = this.page.locator(".govuk-notification-banner");
  readonly notificationBannerTitle = this.notificationBanner.locator(
    ".govuk-notification-banner__title",
  );
  readonly notificationBannerContent = this.notificationBanner.locator(
