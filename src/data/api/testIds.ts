...
export const WA_SAMPLE_ASSIGNED_TASK_ID =
  process.env.WA_SAMPLE_ASSIGNED_TASK_ID;
...
export const ROLE_ACCESS_CASE_ID = resolveRoleAccessCaseId(
  process.env.ROLE_ACCESS_CASE_ID,
);
