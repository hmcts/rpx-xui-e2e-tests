...
export const USER_ENV_MAP: Record<string, UserEnvMapping> = {
  ...
  PRL_SOLICITOR2: { username: "PRL_SOLICITOR2_USERNAME", password: "PRL_SOLICITOR2_PASSWORD" },
  PRL_SOLICITOR3: { username: "PRL_SOLICITOR3_USERNAME", password: "PRL_SOLICITOR3_PASSWORD" },
  PRL_SOLICITOR4: { username: "PRL_SOLICITOR4_USERNAME", password: "PRL_SOLICITOR4_PASSWORD" },
  PRL_SOLICITOR5: { username: "PRL_SOLICITOR5_USERNAME", password: "PRL_SOLICITOR5_PASSWORD" },
  PRL_SOLICITOR6: { username: "PRL_SOLICITOR6_USERNAME", password: "PRL_SOLICITOR6_PASSWORD" },
  PRL_SOLICITOR7: { username: "PRL_SOLICITOR7_USERNAME", password: "PRL_SOLICITOR7_PASSWORD" },
  PRL_SOLICITOR8: { username: "PRL_SOLICITOR8_USERNAME", password: "PRL_SOLICITOR8_PASSWORD" },
  WA_SOLICITOR: {
  ...
  "BOOKING_UI-FT-ON-5": { username: "BOOKING_UI_FT_ON_5_USERNAME", password: "BOOKING_UI_FT_ON_5_PASSWORD" },
  "BOOKING_UI-FT-ON-6": { username: "BOOKING_UI_FT_ON_6_USERNAME", password: "BOOKING_UI_FT_ON_6_PASSWORD" },
  "BOOKING_UI-FT-ON-7": { username: "BOOKING_UI_FT_ON_7_USERNAME", password: "BOOKING_UI_FT_ON_7_PASSWORD" },
  "BOOKING_UI-FT-ON-8": { username: "BOOKING_UI_FT_ON_8_USERNAME", password: "BOOKING_UI_FT_ON_8_PASSWORD" },
  FPL_GLOBAL_SEARCH: {
  ...
  IAC_CASEOFFICER_R1: {
    username: ["PW_IAC_CASEOFFICER_R1_EMAIL", "IAC_CASEOFFICER_R1_USERNAME", "CASEOFFICER_R1_USERNAME", "CASEWORKER_R1_USERNAME"],
    password: ["PW_IAC_CASEOFFICER_R1_PASSWORD", "IAC_CASEOFFICER_R1_PASSWORD", "CASEOFFICER_R1_PASSWORD", "CASEWORKER_R1_PASSWORD"]
  },
  IAC_CASEOFFICER_R2: {
  ...
  "STAFF_ADMIN-5": { username: "STAFF_ADMIN_5_USERNAME", password: "STAFF_ADMIN_5_PASSWORD" },
  "STAFF_ADMIN-6": { username: "STAFF_ADMIN_6_USERNAME", password: "STAFF_ADMIN_6_PASSWORD" },
  "STAFF_ADMIN-7": { username: "STAFF_ADMIN_7_USERNAME", password: "STAFF_ADMIN_7_PASSWORD" },
  "STAFF_ADMIN-8": { username: "STAFF_ADMIN_8_USERNAME", password: "STAFF_ADMIN_8_PASSWORD" },
