  ...
  return {
    ...
    case_fields: [
      ...
      field({
        ...
        fieldType: textFieldType({ id: "DynamicList-service", type: "DynamicList", fixed_list_items: [] }),
        value: {
    ...
    wizard_pages: [
      {
        ...
        order: 1,
        wizard_page_fields: [
          { case_field_id: "CaseTitle", order: 1, page_column_no: null, complex_field_overrides: [] },
          { case_field_id: "CaseType", order: 2, page_column_no: null, complex_field_overrides: [] },
          { case_field_id: "UrgentReason", order: 3, page_column_no: null, complex_field_overrides: [] },
          { case_field_id: "CaseReference", order: 4, page_column_no: null, complex_field_overrides: [] },
          { case_field_id: "HiddenWithoutRetention", order: 5, page_column_no: null, complex_field_overrides: [] },
          { case_field_id: "HiddenWithRetention", order: 6, page_column_no: null, complex_field_overrides: [] },
          { case_field_id: "Service", order: 7, page_column_no: null, complex_field_overrides: [] }
        ],
        show_condition: null,
