...
type CreateCaseAclCrudOverrides = {
  role: string;
  create?: boolean;
  read?: boolean;
  update?: boolean;
...
type CreateCaseAclGroupInput = Array<string | CreateCaseAclCrudOverrides>;
    ...
    case_fields: [
      ...
      },
      {
        ...
        field_type: buildFixedListFieldType({
          ...
          fixedListItems: [
            { code: "unreasonable-behaviour", label: "Behaviour", order: null },
            { code: "adultery", label: "Adultery", order: null },
            { code: "desertion", label: "Desertion", order: null },
            { code: "separation-2-years", label: "2-year separation (with consent)", order: null },
            { code: "separation-5-years", label: "5-year separation", order: null }
          ]
        }),
        validation_expr: null,
        security_label: "PUBLIC",
    ...
    wizard_pages: [
      {
        ...
        order: 2,
        wizard_page_fields: [
          { case_field_id: "DivorceReason", order: 8, page_column_no: null, complex_field_overrides: [] },
          { case_field_id: "TextField1", order: 2, page_column_no: null, complex_field_overrides: [] },
          { case_field_id: "TextField3", order: 1, page_column_no: null, complex_field_overrides: [] },
          { case_field_id: "TextField0", order: 1, page_column_no: null, complex_field_overrides: [] },
          { case_field_id: "TextField2", order: 3, page_column_no: null, complex_field_overrides: [] }
        ],
        show_condition: null,
      ...
      },
      {
        ...
        order: 1,
        wizard_page_fields: [
          { case_field_id: "People", order: 7, page_column_no: null, complex_field_overrides: [] },
          { case_field_id: "Person1", order: 5, page_column_no: null, complex_field_overrides: [] },
          { case_field_id: "Person2", order: 6, page_column_no: null, complex_field_overrides: [] },
          { case_field_id: "Gender", order: 4, page_column_no: null, complex_field_overrides: [] }
        ],
        show_condition: null,
        callback_url_mid_event: null,
        retries_timeout_mid_event: []
