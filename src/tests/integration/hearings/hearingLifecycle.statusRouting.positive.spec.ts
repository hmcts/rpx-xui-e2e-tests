...
import { HEARING_MANAGER_CR84_OFF_USER, hearingManagerRoles, openHearingsTab } from '../helpers/index.js';
import { buildHearingActualsMock, type HearingScenario } from '../mocks/hearings.mock.js';
...
test.describe(
  `@integration-bucket-5 Hearings lifecycle status routing as ${HEARING_MANAGER_CR84_OFF_USER}`,
