...
import { ensureAuthenticatedPage, ensureSession } from '../../common/sessionCapture.js';
...
test.describe('Civil Create Case Flag data loss regression', { tag: '@e2e-civil-data-loss' }, () => {
