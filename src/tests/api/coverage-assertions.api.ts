...
import { extractCaseShareEntries, isTaskList, type CaseShareResponseVariant } from '../../utils/api/types';
...
test.describe('Assertion shape validators', { tag: '@svc-internal' }, () => {
  ...
  test('extractCaseShareEntries and isTaskList cover variants', () => {
    ...
    const missing = extractCaseShareEntries({ foo: 'bar' } as CaseShareResponseVariant, 'cases');
    const empty = extractCaseShareEntries(null as unknown as CaseShareResponseVariant, 'cases');
