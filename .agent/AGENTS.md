...
- For every non-trivial implementation, refactor, or pipeline change, spin up an independent critical review agent and address findings before final handoff.
