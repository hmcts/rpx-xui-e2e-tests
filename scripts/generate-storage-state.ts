...
async function main() {
  ...
  await loginAndSave(environment.caseManager.username, environment.caseManager.password, path.join(outDir, 'caseManager.json'));
  await loginAndSave(environment.judge.username, environment.judge.password, path.join(outDir, 'judge.json'));
}
