#!/usr/bin/env node
/**
 * Copies the Odhín report generated by Playwright into the publish folder and injects
 * coverage + endpoint tabs (mirrors rpx-xui-webapp/scripts/copy-odhin-report.js).
...
const targetRoot = path.resolve("test-results");
